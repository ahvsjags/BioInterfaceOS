...
class R2ReleaseReproductionWorkflow:
    ...
    REPRO_ID = "bioif-r2-software-replay-v2.0.0"
    REPRODUCED_AT = "2026-08-13T00:00:00+00:00"
    OUTPUT_RELATIVE = "reports/review_round_2/reproducibility/r2_software_replay/v2.0.0"

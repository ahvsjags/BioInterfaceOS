...
# Clean-room runner for the current BioInterfaceOS public scientific candidate.
# This creates an execution bundle; it is not an external receipt by itself.

repository_url="https://github.com/ahvsjags/BioInterfaceOS.git"
expected_tag="v0.1.3-r10.57"
...
sha256sum uv.lock pyproject.toml CITATION.cff \
  release/empirical_candidate_v0.1.3-r10.57/release_manifest.json \

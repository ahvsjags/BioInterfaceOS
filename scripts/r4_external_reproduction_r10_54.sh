...
# Clean-room runner for the BioInterfaceOS external-reproduction candidate.
# The fixed tag, not a mutable branch, is the scientific input. This script
# never writes scientific_submission_ready=true and never claims to be an
# external receipt by itself.

repository_url="https://github.com/ahvsjags/BioInterfaceOS.git"
expected_tag="v0.1.3-r10.54"
...
sha256sum uv.lock pyproject.toml CITATION.cff \
  release/empirical_candidate_v0.1.3-r10.54/release_manifest.json \
